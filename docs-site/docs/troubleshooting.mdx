...
If you are still having trouble, please reach out to us via Intercom on the [0xArc App](https://app.0xarc.io), via [twitter](https://x.com/0xarc_io) or via [email](mailto:k@0xarc.io).
