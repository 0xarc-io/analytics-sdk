...
We highly recommend that you restrict the whitelisted domains to avoid abuse of your SDK by malicious actors.

You can update the whitelisted domains under your API key in the project settings as outlined in [step 4 above](/retrieve-api-key#i-already-have-an-account-on-the-0xarc-app).
